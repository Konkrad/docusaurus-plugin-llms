...
const tests = [
  ...
  },
  {
    ...
    input:
      'This is a very long description that should be truncated at a word boundary to avoid cutting words in half and making the text look awkward when displayed in the table of contents',
